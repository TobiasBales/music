...
ActiveRecord::Schema[7.0].define(version: 2022_12_31_212335) do
  ...
  create_table "course_permissions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "course_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["course_id"], name: "index_course_permissions_on_course_id"
  end

  create_table "course_permissions_users", id: false, force: :cascade do |t|
    t.uuid "course_permission_id", null: false
    t.uuid "user_id", null: false
    t.index ["course_permission_id"], name: "index_course_permissions_users_on_course_permission_id"
    t.index ["user_id"], name: "index_course_permissions_users_on_user_id"
  end
  ...
  add_foreign_key "course_permissions", "courses"
  add_foreign_key "course_permissions_users", "course_permissions"
  add_foreign_key "course_permissions_users", "users"
