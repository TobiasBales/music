...
module StrongMigrations
  class << self
    # source://strong_migrations//lib/strong_migrations.rb#64
    ...
    # private
    #
    # source://strong_migrations//lib/strong_migrations.rb#48
    def env; end
    ...
    # source://strong_migrations//lib/strong_migrations.rb#57
...
class StrongMigrations::Adapters::MySQLAdapter < ::StrongMigrations::Adapters::AbstractAdapter
  ...
  # source://strong_migrations//lib/strong_migrations/adapters/mysql_adapter.rb#73
  def rewrite_blocks; end
  ...
  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/adapters/mysql_adapter.rb#68
  def strict_mode?; end
  ...
  # want latest value
  #
  # source://strong_migrations//lib/strong_migrations/adapters/mysql_adapter.rb#81
  def sql_modes; end
end
...
class StrongMigrations::Checker
  ...
  # source://strong_migrations//lib/strong_migrations/checker.rb#102
  ...
  # source://strong_migrations//lib/strong_migrations/checker.rb#147
  def check_lock_timeout; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#120
  def check_version_supported; end

  # source://strong_migrations//lib/strong_migrations/checker.rb#189
  def connection; end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checker.rb#193
  def retry_lock_timeouts?(method); end

  # @return [Boolean]
  #
  # source://strong_migrations//lib/strong_migrations/checker.rb#157
  def safe?; end
...
module StrongMigrations::Checks
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#439
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#76
  ...
  #
  # source://strong_migrations//lib/strong_migrations/checks.rb#96
  def check_add_foreign_key(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#113
  def check_add_index(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#138
  def check_add_reference(method, *args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#176
  def check_change_column(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#197
  def check_change_column_null(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#273
  def check_change_table; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#277
  def check_create_join_table(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#285
  def check_create_table(*args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#295
  def check_execute; end

  # source://strong_migrations//lib/strong_migrations/checks.rb#299
  def check_remove_column(method, *args); end

  # source://strong_migrations//lib/strong_migrations/checks.rb#331
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#362
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#416
  ...
  # source://strong_migrations//lib/strong_migrations/checks.rb#392
