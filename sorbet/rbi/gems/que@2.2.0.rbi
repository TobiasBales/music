...
# source://que//lib/que/active_job/extensions.rb#109
class ActiveJob::QueueAdapters::QueAdapter
  # source://activejob/7.0.4/lib/active_job/queue_adapters/que_adapter.rb#20
  def enqueue(job); end

  # source://activejob/7.0.4/lib/active_job/queue_adapters/que_adapter.rb#34
  def enqueue_at(job, timestamp); end

  private

  # source://activejob/7.0.4/lib/active_job/queue_adapters/que_adapter.rb#49
  def require_job_options_kwarg?; end
end

# source://que//lib/que/active_job/extensions.rb#110
class ActiveJob::QueueAdapters::QueAdapter::JobWrapper < ::Que::Job
  ...
  # source://que//lib/que/active_job/extensions.rb#78
  def run(args); end
end
...
module Que::ActiveJob::JobExtensions
  ...
  # source://que//lib/que/active_job/extensions.rb#14
  ...
  # expected.
  #
  # source://que//lib/que/active_job/extensions.rb#46
  ...
  #
  # source://que//lib/que/active_job/extensions.rb#40
  def que_target; end
end
...
#
# source://que//lib/que/active_job/extensions.rb#62
module Que::ActiveJob::WrapperExtensions; end

# source://que//lib/que/active_job/extensions.rb#63
...
# source://que//lib/que/active_job/extensions.rb#70
module Que::ActiveJob::WrapperExtensions::InstanceMethods
  ...
  # oblige it.
  #
  # source://que//lib/que/active_job/extensions.rb#74
  def attrs; end
...
# source://que//lib/que/locker.rb#31
class Que::Locker
  ...
  # Returns the value of attribute job_buffer.
  #
  # source://que//lib/que/locker.rb#32
  def job_buffer; end
  ...
  # source://que//lib/que/locker.rb#215
  def stop; end

  # source://que//lib/que/locker.rb#211
  def stop!; end
  ...
  # Returns the value of attribute connection.
  #
  # source://que//lib/que/locker.rb#230
  def connection; end

  # source://que//lib/que/locker.rb#282
  def cycle; end

  # source://que//lib/que/locker.rb#460
  def finish_jobs(metajobs); end

  # source://que//lib/que/locker.rb#380
  def handle_results; end

  # source://que//lib/que/locker.rb#393
  def lock_jobs(metajobs); end

  # source://que//lib/que/locker.rb#501
  def mark_id_as_locked(id); end

  # source://que//lib/que/locker.rb#312
  def poll; end
  ...
  # source://que//lib/que/locker.rb#433
  def push_jobs(metajobs); end

  # source://que//lib/que/locker.rb#302
  def shutdown; end

  # source://que//lib/que/locker.rb#267
  def startup; end

  # source://que//lib/que/locker.rb#464
  def unlock_jobs(metajobs); end

  # source://que//lib/que/locker.rb#366
  def wait; end

  # source://que//lib/que/locker.rb#308
  def wait_for_shutdown; end

  # source://que//lib/que/locker.rb#232
  def work_loop; end
end

# source://que//lib/que/locker.rb#48
Que::Locker::DEFAULT_MAXIMUM_BUFFER_SIZE = T.let(T.unsafe(nil), Integer)

# source://que//lib/que/locker.rb#46
Que::Locker::DEFAULT_POLL_INTERVAL = T.let(T.unsafe(nil), Float)

# source://que//lib/que/locker.rb#47
Que::Locker::DEFAULT_WAIT_PERIOD = T.let(T.unsafe(nil), Integer)

# source://que//lib/que/locker.rb#49
Que::Locker::DEFAULT_WORKER_PRIORITIES = T.let(T.unsafe(nil), Array)

# source://que//lib/que/locker.rb#34
