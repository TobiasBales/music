...
# This is an autogenerated file for dynamic methods in `Exercise`.
...
class Exercise
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Exercise).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.untyped) }
    def average(column_name); end

    sig { params(attributes: T.untyped, block: T.nilable(T.proc.params(object: ::Exercise).void)).returns(::Exercise) }
    ...
    sig { params(args: T.untyped).returns(T.nilable(::Exercise)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Exercise) }
    def find_by!(*args); end
    ...
    sig { params(arg: T.untyped, args: T.untyped).returns(::Exercise) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::Exercise } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Exercise, T::Enumerable[T.any(::Exercise, T::Enumerable[::Exercise])])
    ...
    sig do
      params(
        records: T.any(::Exercise, Integer, String, T::Enumerable[T.any(::Exercise, Integer, String, T::Enumerable[::Exercise])])
      ).returns(T::Array[::Exercise])
    end
    ...
    sig do
      params(
        other_array: T.any(::Exercise, T::Enumerable[T.any(::Exercise, T::Enumerable[::Exercise])])
      ).returns(T::Array[::Exercise])
    end
