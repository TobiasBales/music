...
class Profile
  ...
  module GeneratedAttributeMethods
    ...
    def count_in_before_last_save; end

    sig { returns(T.untyped) }
    def count_in_before_type_cast; end
    ...
    sig { returns(T::Boolean) }
    def count_in_previously_changed?; end

    sig { returns(T.nilable(T::Boolean)) }
    def count_in_previously_was; end

    sig { returns(T.nilable(T::Boolean)) }
    def count_in_was; end

    sig { void }
    def count_in_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_count_in?; end
