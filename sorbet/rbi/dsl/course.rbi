...
class Course
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Course` class because it declared `has_many :enrollments`.
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.untyped) }
    def instrument_id; end

    sig { params(value: T.untyped).returns(T.untyped) }
    def instrument_id=(value); end

    sig { returns(T::Boolean) }
    def instrument_id?; end

    sig { returns(T.untyped) }
    def instrument_id_before_last_save; end

    sig { returns(T.untyped) }
    def instrument_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def instrument_id_came_from_user?; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def instrument_id_change; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def instrument_id_change_to_be_saved; end

    sig { returns(T::Boolean) }
    def instrument_id_changed?; end

    sig { returns(T.untyped) }
    def instrument_id_in_database; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def instrument_id_previous_change; end

    sig { returns(T::Boolean) }
    def instrument_id_previously_changed?; end

    sig { returns(T.untyped) }
    def instrument_id_previously_was; end

    sig { returns(T.untyped) }
    def instrument_id_was; end
